...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "#badc57"
        title = Label(self.root, text="Billing Software", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="salmon", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="gray")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="gray", fg="black")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="gray", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="gray", fg="black")
        ...
        syrup_lbl = Label(F2, text="Syrup", font=('times new roman', 16, 'bold'), bg="gray", fg="black")
        ...
        cream_lbl = Label(F2, text="Cream", font=('times new roman', 16, 'bold'), bg = "gray", fg = "black")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="gray", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="steel blue1")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
        ...
        spices_lbl = Label(F3, text="Spices", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="steel blue1", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="dark salmon")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
        ...
        mineral_lbl = Label(F4, text="Mineral Water", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
        ...
        juice_lbl = Label(F4, text="Juice", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
        ...
        lassi_lbl = Label(F4, text="Lassi", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="dark salmon", fg="black")
    ...
    # =======Buttons-======================================
        ...
        total_btn = Button(btn_f, command=self.total, text="Total", bg="blue", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
        total_btn.grid(row=0, column=0, padx=5, pady=5)

        generateBill_btn = Button(btn_f, command=self.bill_area, text="Generate Bill", bd=2, bg="green", fg="white", pady=12, width=12, font='arial 13 bold')
        ...
        exit_btn = Button(btn_f, command=self.exit_app, text="Exit", bd=2, bg="red", fg="white", pady=15, width=12, font='arial 13 bold')
